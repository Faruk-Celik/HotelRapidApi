namespace HotelRapidApi.Models
{
    public class HotelLocationViewModel
    {
        ...
        {
            public Component9 component { get; set; }
            public string text { get; set; }
        }
        ...
        public class Props18
        {
            ...
            public Component10 component { get; set; }
        }
        ...
        public class Item8
        {
            public Props21 props { get; set; }
        }

        public class Props21
        {
            public Component11 component { get; set; }
        }

        public class Component11
        {
            public Props22 props { get; set; }
        }

        public class Props22
        {
            public string size { get; set; }
